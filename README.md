...
| `/adm` | GRP\_ADM | \*\*770\*\* (rwxrwx---) | Apenas usuários do grupo ADM têm acesso total. |

| `/ven` | GRP\_VEN | \*\*770\*\* (rwxrwx---) | Apenas usuários do grupo VEN têm acesso total. |

| `/sec` | GRP\_SEC | \*\*770\*\* (rwxrwx---) | Apenas usuários do grupo SEC têm acesso total. |
...
| \*\*GRP\_ADM\*\* (Administração) | `LeoAdm`, `MariaAdm`, `JoseAdm` |

| \*\*GRP\_VEN\*\* (Vendas) | `GilVen`, `BrunoVen`, `MarioVen` |

| \*\*GRP\_SEC\*\* (Secretariado) | `RobSec`, `ThaisSec`, `FelipeSec` |
